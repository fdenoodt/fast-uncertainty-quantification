...
class W:  # W for wandb
    ...
    def get_wandb_project_name(h: dict):
        ...
        run_name = f"alpha={h['alpha']} nb_views={h['num_views']}"  # f"{family}_kld={options.encoder_config.kld_weight}_lr={options.encoder_config.learning_rate}_{int(time.time())}"
